...
export async function Projects() {
	...
	const projectItems = await client.fetch<SanityProject[]>(allProjectsQueryDetailed, {}, options);

	// Transform Sanity data using the imported function
	const transformedProjects: ProjectItem[] = transformSanityProjects(projectItems);
